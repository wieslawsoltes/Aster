...
(() => {
    ...
    const privateSelector='[data-private],input[type="password"],[autocomplete="one-time-code"],[autocomplete^="cc-"],[autocomplete="current-password"],[autocomplete="new-password"]';
