...
((root) => {
    ...
    const SECTIONS = Object.freeze({'':'home',defaultapps:'defaultapps',startupapps:'startupapps',display:'display',sound:'sound',notifications:'notifications',focus:'focus',clipboard:'clipboard',storagesense:'storage',multitasking:'multitasking',recovery:'recovery',personalization:'personalization','easeofaccess-display':'accessibility',privacy:'privacy',about:'about','dateandtime':'time'});
